...
window.objectivesData = window.objectivesData || {
    easy: {
        title: "Level 10 - Larong Kalye Leaderboard (Easy) - Java",
        objectives: [
            "Create a Java class named 'LarongKalyeLeaderboard'",
            "Add a main method to start your program",
            "Store 3 player names and scores in an array",
    ...
    difficult: {
        title: "Level 10 - Larong Kalye Leaderboard (Difficult) - Java",
        objectives: [
