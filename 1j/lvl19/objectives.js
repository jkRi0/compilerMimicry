...
window.objectivesData = window.objectivesData || {
    easy: {
        title: "Level 19 - Aswang Alert Tracker (Easy) - Java",
        objectives: [
            "Create a Java class named 'AswangAlertTracker'",
    ...
    average: {
        title: "Level 19 - Aswang Alert Tracker (Average) - Java",
        objectives: [
    ...
    difficult: {
        title: "Level 19 - Aswang Alert Tracker (Difficult) - Java",
        objectives: [
