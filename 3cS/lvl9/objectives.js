...
window.objectivesData = window.objectivesData || {
    easy: {
        ...
        objectives: [
            ...
            "Use String methods: ToUpper() and string concatenation",
            "Print the formatted slogan with borders using Console.WriteLine"
        ]
    },
    average: {
        ...
        objectives: [
            ...
            "Use Console.ReadLine for input and String methods for analysis"
        ]
    },
    difficult: {
