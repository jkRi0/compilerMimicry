...
window.objectivesData = window.objectivesData || {
    easy: {
        title: "Level 2 - Sari-Sari Store Inventory (Easy) - C#",
        objectives: [
            ...
            "Print each product name using Console.WriteLine"
        ]
    },
    average: {
        title: "Level 2 - Sari-Sari Store Inventory (Average) - C#",
        objectives: [
    ...
    difficult: {
        ...
        objectives: [
            "Allow input to update stock levels using Console.ReadLine",
