...
window.objectivesData = window.objectivesData || {
    easy: {
        title: "Level 20 - Jeepney Fare Matrix Calculator (Easy) - C#",
        objectives: [
            "Create a C# program named 'JeepneyFareMatrix'",
    ...
    average: {
        title: "Level 20 - Jeepney Fare Matrix Calculator (Average) - C#",
        objectives: [
    ...
    difficult: {
        title: "Level 20 - Jeepney Fare Matrix Calculator (Difficult) - C#",
        objectives: [
