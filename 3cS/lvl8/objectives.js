...
window.objectivesData = window.objectivesData || {
    easy: {
        title: "Level 8 - Tikbalang Path Puzzle (Easy) - C#",
        objectives: [
            ...
            "Print each move using a for loop and Console.WriteLine"
        ]
    },
    average: {
        ...
        objectives: [
            ...
            "Use Random class to generate random moves",
    ...
    difficult: {
        title: "Level 8 - Tikbalang Path Puzzle (Difficult) - C#",
        objectives: [
